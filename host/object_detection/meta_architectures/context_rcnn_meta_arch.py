...
class ContextRCNNMetaArch(faster_rcnn_meta_arch.FasterRCNNMetaArch):
    ...
    def __init__(
        ...
        attention_position=(faster_rcnn_pb2.AttentionPosition.POST_BOX_CLASSIFIER),
    ):
    ...
    def get_side_inputs(features):
        ...
        """
        if (
            fields.InputDataFields.context_features not in features
            or fields.InputDataFields.valid_context_size not in features
        ):
            raise ValueError(
        ...
        return {
            fields.InputDataFields.context_features: features[
                fields.InputDataFields.context_features
            ],
            fields.InputDataFields.valid_context_size: features[
    ...
    def _compute_second_stage_input_feature_maps(
        ...
        if self._attention_position == (faster_rcnn_pb2.AttentionPosition.POST_RPN):
