...
from object_detection.predictors import (
    convolutional_keras_box_predictor as box_predictor,
)
...
class ConvolutionalKerasBoxPredictorTest(test_case.TestCase):
    ...
    def test_get_predictions_with_feature_maps_of_dynamic_shape(self):
        ...
        self.assertAllEqual(objectness_predictions.shape, [4, expected_num_anchors, 1])
...
class WeightSharedConvolutionalKerasBoxPredictorTest(test_case.TestCase):
    ...
    def test_other_heads_predictions(self):
        ...
        other_heads = {
            other_head_name: keras_mask_head.WeightSharedConvolutionalMaskHead(
                num_classes=num_classes_without_background,
                conv_hyperparams=self._build_conv_hyperparams(),
                num_predictions_per_location=num_predictions_per_location,
