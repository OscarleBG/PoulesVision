...
class ConvolutionalClassHead(head.KerasHead):
    ...
    def _predict(self, features):
        ...
        class_predictions_with_background = tf.reshape(
            class_predictions_with_background, [batch_size, -1, self._num_class_slots]
        )
...
class MaskRCNNClassHead(head.KerasHead):
    ...
    def __init__(
        ...
        self._class_predictor_layers.append(
            tf.keras.layers.Dense(self._num_class_slots, name="ClassPredictor_dense")
        )
        self._class_predictor_layers.append(
            fc_hyperparams.build_batch_norm(
                training=(is_training and not freeze_batchnorm),
    ...
    def _predict(self, features):
        ...
        class_predictions_with_background = tf.reshape(
            ...
            [
                ...
                height,
                width,
                self._num_predictions_per_location,
