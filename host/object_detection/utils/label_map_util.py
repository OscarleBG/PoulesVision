...
def get_label_map_dict(
    label_map_path_or_proto, use_display_name=False, fill_in_gaps_and_background=False
):
...
def get_label_map_hierarchy_lut(label_map_path_or_proto, include_identity=False):
