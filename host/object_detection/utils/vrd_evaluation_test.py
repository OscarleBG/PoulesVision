...
class VRDRelationDetectionEvaluatorTest(tf.test.TestCase):
    def test_vrdrelation_evaluator(self):
        ...
        self.vrd_eval.add_single_ground_truth_image_info(
            image_key1,
            {
                standard_fields.InputDataFields.groundtruth_boxes: groundtruth_box_tuples1,
                standard_fields.InputDataFields.groundtruth_classes: groundtruth_class_tuples1,
                standard_fields.InputDataFields.groundtruth_image_classes: groundtruth_verified_labels1,
            },
        )
        ...
        self.vrd_eval.add_single_ground_truth_image_info(
            image_key2,
            {
                standard_fields.InputDataFields.groundtruth_boxes: groundtruth_box_tuples2,
                standard_fields.InputDataFields.groundtruth_classes: groundtruth_class_tuples2,
            },
        )
        ...
        self.vrd_eval.add_single_ground_truth_image_info(
            image_key3,
            {
                standard_fields.InputDataFields.groundtruth_boxes: groundtruth_box_tuples3,
                standard_fields.InputDataFields.groundtruth_classes: groundtruth_class_tuples3,
            },
        )
        ...
        self.vrd_eval.add_single_detected_image_info(
            image_key,
            {
                standard_fields.DetectionResultFields.detection_boxes: detected_box_tuples,
                standard_fields.DetectionResultFields.detection_scores: detected_scores,
                standard_fields.DetectionResultFields.detection_classes: detected_class_tuples,
            },
        )
        ...
        self.assertAlmostEqual(
            metrics["VRDMetric_Relationships_weightedAP@0.5IOU"], 0.25
        )
        self.assertAlmostEqual(
            metrics["VRDMetric_Relationships_mAP@0.5IOU"], 0.1666666666666666
        )
        self.assertAlmostEqual(
            metrics["VRDMetric_Relationships_AP@0.5IOU/3"], 0.3333333333333333
        )
        self.assertAlmostEqual(metrics["VRDMetric_Relationships_AP@0.5IOU/4"], 0)
        self.assertAlmostEqual(
            metrics["VRDMetric_Relationships_Recall@50@0.5IOU"], 0.25
        )
        self.assertAlmostEqual(
            metrics["VRDMetric_Relationships_Recall@100@0.5IOU"], 0.25
        )
        self.vrd_eval.clear()
...
class VRDPhraseDetectionEvaluatorTest(tf.test.TestCase):
    def test_vrdphrase_evaluator(self):
        ...
        self.assertAlmostEqual(
            metrics["VRDMetric_Phrases_mAP@0.5IOU"], 0.1666666666666666
        )
        self.assertAlmostEqual(
            metrics["VRDMetric_Phrases_AP@0.5IOU/3"], 0.3333333333333333
        )
...
class VRDDetectionEvaluationTest(tf.test.TestCase):
    def setUp(self):
        ...
        self.assertAlmostEqual(
            expected_weighted_average_precision, metrics.weighted_average_precision
        )
        self.assertAlmostEqual(
            expected_mean_average_precision, metrics.mean_average_precision
        )
        self.assertAlmostEqual(
            expected_mean_average_precision, metrics.mean_average_precision
        )
