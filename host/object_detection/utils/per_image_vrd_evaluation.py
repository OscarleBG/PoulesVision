...
class PerImageVRDEvaluation(object):
    ...
    def _compute_tp_fp(
        ...
        return (
            ...
            result_tp_fp_labels[sorted_indices],
            result_mapping[sorted_indices],
        )

    def _get_overlaps_and_scores_relation_tuples(
        self, detected_box_tuples, groundtruth_box_tuples
    ):
        ...
        result_iou = np.ones(
            (detected_box_tuples.shape[0], groundtruth_box_tuples.shape[0]), dtype=float
        )
