...
def _extract_predictions_and_losses(
    model, create_input_dict_fn, ignore_groundtruth=False
):
    ...
    if not ignore_groundtruth:
        groundtruth = {
            fields.InputDataFields.groundtruth_boxes: input_dict[
                fields.InputDataFields.groundtruth_boxes
            ],
            fields.InputDataFields.groundtruth_classes: input_dict[
                fields.InputDataFields.groundtruth_classes
            ],
            fields.InputDataFields.groundtruth_area: input_dict[
                fields.InputDataFields.groundtruth_area
            ],
            fields.InputDataFields.groundtruth_is_crowd: input_dict[
                fields.InputDataFields.groundtruth_is_crowd
            ],
            fields.InputDataFields.groundtruth_difficult: input_dict[
                fields.InputDataFields.groundtruth_difficult
            ],
        }
        if fields.InputDataFields.groundtruth_group_of in input_dict:
            groundtruth[fields.InputDataFields.groundtruth_group_of] = input_dict[
                fields.InputDataFields.groundtruth_group_of
            ]
        groundtruth_masks_list = None
        if fields.DetectionResultFields.detection_masks in detections:
            groundtruth[fields.InputDataFields.groundtruth_instance_masks] = input_dict[
        ...
        if fields.DetectionResultFields.detection_keypoints in detections:
            groundtruth[fields.InputDataFields.groundtruth_keypoints] = input_dict[
...
def evaluate(
    ...
    if eval_config.ignore_groundtruth and not eval_config.export_path:
        logging.fatal(
            "If ignore_groundtruth=True then an export_path is " "required. Aborting!!!"
        )
