...
flags.DEFINE_string(
    "input_annotations_boxes", None, "File with groundtruth boxes annotations."
)
flags.DEFINE_string(
    "input_annotations_labels", None, "File with groundtruth labels annotations."
)
flags.DEFINE_string(
    "input_predictions",
    None,
...
flags.DEFINE_string("input_class_labelmap", None, "Open Images Challenge labelmap.")
flags.DEFINE_string("output_metrics", None, "Output file with csv metrics.")
flags.DEFINE_string(
    "input_annotations_segm",
    None,
