...
class LVISToolsTest(tf.test.TestCase):
    def setUp(self):
        ...
        mask1 = np.pad(
            np.ones([100, 100], dtype=np.uint8), ((100, 56), (100, 56)), mode="constant"
        )
        mask2 = np.pad(
            np.ones([50, 50], dtype=np.uint8), ((50, 156), (50, 156)), mode="constant"
        )
        ...
        self._detections_list = [
            {"image_id": 1, "category_id": 1, "segmentation": mask1_rle, "score": 0.8},
            {"image_id": 2, "category_id": 1, "segmentation": mask2_rle, "score": 0.7},
        ]
    ...
    def testLVISWrappers(self):
        ...
        evaluator = lvis_tools.LVISEvalWrapper(groundtruth, detections, iou_type="segm")
