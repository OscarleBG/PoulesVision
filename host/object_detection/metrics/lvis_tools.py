...
class LVISEvalWrapper(lvis_eval.LVISEval):
    ...
    def __init__(self, groundtruth=None, detections=None, iou_type="bbox"):
        lvis_eval.LVISEval.__init__(self, groundtruth, detections, iou_type=iou_type)
...
def ExportSingleImageGroundtruthToLVIS(
    image_id,
    next_annotation_id,
    category_id_set,
    groundtruth_boxes,
...
def ExportSingleImageDetectionMasksToLVIS(
