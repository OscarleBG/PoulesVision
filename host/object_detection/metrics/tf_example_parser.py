...
class StringParser(data_parser.DataToNumpyParser):
    ...
    def parse(self, tf_example):
        return (
            b"".join(tf_example.features.feature[self.field_name].bytes_list.value)
...
class TfExampleDetectionAndGTParser(data_parser.DataToNumpyParser):
    ...
    def __init__(self):
        self.items_to_handlers = {
            fields.DetectionResultFields.key: StringParser(
        ...
        self.optional_items_to_handlers = {
            fields.InputDataFields.groundtruth_difficult: Int64Parser(
                fields.TfExampleFields.object_difficult
            ),
            fields.InputDataFields.groundtruth_group_of: Int64Parser(
                fields.TfExampleFields.object_group_of
            ),
            fields.InputDataFields.groundtruth_image_classes: Int64Parser(
