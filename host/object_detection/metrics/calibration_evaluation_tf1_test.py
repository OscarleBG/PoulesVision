...
class CalibrationDetectionEvaluationTest(tf.test.TestCase):
    ...
    def testGetECEWithMatchingGroundtruthAndDetections(self):
        ...
        base_eval_dict = {
            input_data_fields.key: tf.constant(["image_1", "image_2", "image_3"]),
            input_data_fields.groundtruth_boxes: tf.constant(
                [
            ...
            detection_fields.detection_boxes: tf.constant(
                [
                    [[100.0, 100.0, 200.0, 200.0]],
                    [[50.0, 50.0, 100.0, 100.0]],
                    [[25.0, 25.0, 50.0, 50.0]],
            ...
            input_data_fields.groundtruth_classes: tf.constant(
            ...
            detection_fields.detection_scores: tf.constant(
    ...
    def testGetECEWithUnmatchedGroundtruthAndDetections(self):
        ...
        eval_dict = {
            ...
            detection_fields.detection_classes: tf.constant(
                [[1], [1], [3]], dtype=tf.int64
            ),
        ...
        eval_dict = {
            ...
            input_data_fields.groundtruth_boxes: tf.constant(
                [
                    ...
                    [[50.0, 50.0, 100.0, 100.0], [100.0, 100.0, 200.0, 200.0]],
                    [[25.0, 25.0, 50.0, 50.0], [100.0, 100.0, 200.0, 200.0]],
                ],
                dtype=tf.float32,
            ),
            detection_fields.detection_boxes: tf.constant(
                [
                    [[100.0, 100.0, 200.0, 200.0], [50.0, 50.0, 100.0, 100.0]],
                    [[50.0, 50.0, 100.0, 100.0], [25.0, 25.0, 50.0, 50.0]],
                    [[25.0, 25.0, 50.0, 50.0], [100.0, 100.0, 200.0, 200.0]],
                ],
                dtype=tf.float32,
            ),
            input_data_fields.groundtruth_classes: tf.constant(
                [[1, 2], [2, 3], [3, 1]], dtype=tf.int64
            ),
            detection_fields.detection_classes: tf.constant(
                [[1, 2], [1, 1], [3, 1]], dtype=tf.int64
            ),
            detection_fields.detection_scores: tf.constant(
                [[1.0, 1.0], [0.0, 0.0], [1.0, 1.0]], dtype=tf.float32
            ),
        }
