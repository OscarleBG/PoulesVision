...
def _get_category_keypoints_dict():
    return {
        "person": [{"id": 0, "name": "left_eye"}, {"id": 3, "name": "right_eye"}],
        "dog": [{"id": 1, "name": "tail_start"}, {"id": 2, "name": "mouth"}],
    }
...
class CocoDetectionEvaluationTest(tf.test.TestCase):
    def testGetOneMAPWithMatchingGroundtruthAndDetections(self):
        ...
        coco_evaluator.add_single_detected_image_info(
            ...
            detections_dict={
                ...
                standard_fields.DetectionResultFields.detection_scores: np.array([0.8]),
                standard_fields.DetectionResultFields.detection_classes: np.array([1]),
            },
        )
        coco_evaluator.add_single_ground_truth_image_info(
            image_id="image2",
    ...
    def testGetOneMAPWithMatchingGroundtruthAndDetectionsSkipCrowd(self):
        ...
        coco_evaluator.add_single_ground_truth_image_info(
            ...
            groundtruth_dict={
                standard_fields.InputDataFields.groundtruth_boxes: np.array(
                    [[100.0, 100.0, 200.0, 200.0], [99.0, 99.0, 200.0, 200.0]]
                ),
                standard_fields.InputDataFields.groundtruth_classes: np.array([1, 2]),
                standard_fields.InputDataFields.groundtruth_is_crowd: np.array([0, 1]),
            },
        )
        coco_evaluator.add_single_detected_image_info(
            image_id="image1",
...
class CocoEvaluationPyFuncTest(tf.test.TestCase):
    def _MatchingGroundtruthAndDetections(self, coco_evaluator):
        ...
        with self.test_session() as sess:
            sess.run(
                ...
                feed_dict={
                    image_id: "image1",
                    groundtruth_boxes: np.array([[100.0, 100.0, 200.0, 200.0]]),
            ...
            sess.run(
                ...
                feed_dict={
                    image_id: "image2",
                    groundtruth_boxes: np.array([[50.0, 50.0, 100.0, 100.0]]),
                    groundtruth_classes: np.array([3]),
                    detection_boxes: np.array([[50.0, 50.0, 100.0, 100.0]]),
                    detection_scores: np.array([0.7]),
            ...
            sess.run(
                ...
                feed_dict={
                    image_id: "image3",
                    groundtruth_boxes: np.array([[25.0, 25.0, 50.0, 50.0]]),
                    groundtruth_classes: np.array([2]),
                    detection_boxes: np.array([[25.0, 25.0, 50.0, 50.0]]),
    ...
    def testGetMAPWithSkipUnmatchedPredictionsIgnoreGrountruthLabeledClasses(self):
    ...
    def testGetMAPWithSkipUnmatchedPredictions(self):
        ...
        eval_dict = {
            ...
            input_data_fields.groundtruth_boxes: groundtruth_boxes,
            input_data_fields.groundtruth_classes: groundtruth_classes,
            input_data_fields.groundtruth_labeled_classes: groundtruth_labeled_classes,
            detection_fields.detection_boxes: detection_boxes,
            detection_fields.detection_scores: detection_scores,
            detection_fields.detection_classes: detection_classes,
        }
        ...
        with self.test_session() as sess:
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_labeled_classes: np.array([0.0, 1.0, 0.0, 0.0]),
                    detection_boxes: np.array(
                        [[100.0, 100.0, 200.0, 200.0], [100.0, 100.0, 200.0, 200.0]]
                    ),
                    detection_scores: np.array([0.8, 0.95]),
            ...
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_boxes: np.array([[50.0, 50.0, 100.0, 100.0]]),
                    groundtruth_classes: np.array([3]),
                    groundtruth_labeled_classes: np.array([0.0, 0.0, 0.0, 1.0]),
                    detection_boxes: np.array([[50.0, 50.0, 100.0, 100.0]]),
                    detection_scores: np.array([0.7]),
                    detection_classes: np.array([3]),
                },
            ...
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_boxes: np.array([[25.0, 25.0, 50.0, 50.0]]),
                    groundtruth_classes: np.array([2]),
                    groundtruth_labeled_classes: np.array([0.0, 0.0, 1.0, 0.0]),
                    detection_boxes: np.array([[25.0, 25.0, 50.0, 50.0]]),
                    detection_scores: np.array([0.9]),
                    detection_classes: np.array([2]),
                },
        ...
        with self.test_session() as sess:
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_boxes: np.array(
                        [[100.0, 100.0, 200.0, 200.0], [-1, -1, -1, -1]]
                    ),
                    groundtruth_classes: np.array([1, -1]),
                    detection_boxes: np.array(
                        [[100.0, 100.0, 200.0, 200.0], [0.0, 0.0, 0.0, 0.0]]
                    ),
                    detection_scores: np.array([0.8, 0.0]),
            ...
            sess.run(
                ...
                feed_dict={
                    image_id: "image2",
                    groundtruth_boxes: np.array(
                        [[50.0, 50.0, 100.0, 100.0], [-1, -1, -1, -1]]
                    ),
                    groundtruth_classes: np.array([3, -1]),
                    detection_boxes: np.array(
                        [[50.0, 50.0, 100.0, 100.0], [0.0, 0.0, 0.0, 0.0]]
                    ),
                    detection_scores: np.array([0.7, 0.0]),
                    detection_classes: np.array([3, -1]),
                },
            )
            sess.run(
                update_op,
                feed_dict={
                    image_id: "image3",
                    groundtruth_boxes: np.array(
                        [[25.0, 25.0, 50.0, 50.0], [10.0, 10.0, 15.0, 15.0]]
                    ),
                    groundtruth_classes: np.array([2, 2]),
                    detection_boxes: np.array(
                        [[25.0, 25.0, 50.0, 50.0], [10.0, 10.0, 15.0, 15.0]]
                    ),
                    detection_scores: np.array([0.95, 0.9]),
                    detection_classes: np.array([2, 2]),
                },
            )
        metrics = {}
        for key, (value_op, _) in eval_metric_ops.items():
            ...
            sess.run(
                ...
                feed_dict={
                    ...
                    detection_scores: np.array(
                        [[0.8, 0.0, 0.0], [0.7, 0.0, 0.0], [0.95, 0.9, 0.9]]
                    ),
                    detection_classes: np.array([[1, -1, -1], [3, -1, -1], [2, 2, 2]]),
                    num_det_boxes_per_image: np.array([1, 1, 3]),
                },
            )
...
class CocoKeypointEvaluationTest(tf.test.TestCase):
    def testGetOneMAPWithMatchingKeypoints(self):
        ...
        coco_evaluator = coco_evaluation.CocoKeypointEvaluator(
            category_id=1,
            category_keypoints=category_keypoint_dict["person"],
            class_text="person",
        )
        coco_evaluator.add_single_ground_truth_image_info(
            image_id="image1",
            groundtruth_dict={
                ...
                standard_fields.InputDataFields.groundtruth_classes: np.array([1]),
                standard_fields.InputDataFields.groundtruth_keypoints: np.array(
                    [
                        [
                            [150.0, 160.0],
                            [float("nan"), float("nan")],
                ...
                standard_fields.InputDataFields.groundtruth_keypoint_visibilities: np.array(
                    [[2, 0, 0, 2]]
                ),
            },
        )
        coco_evaluator.add_single_detected_image_info(
            ...
            detections_dict={
                ...
                standard_fields.DetectionResultFields.detection_scores: np.array([0.8]),
                standard_fields.DetectionResultFields.detection_classes: np.array([1]),
                standard_fields.DetectionResultFields.detection_keypoints: np.array(
                    [[[150.0, 160.0], [1.0, 2.0], [3.0, 4.0], [170.0, 180.0]]]
                ),
            },
        )
        coco_evaluator.add_single_ground_truth_image_info(
        ...
        coco_evaluator.add_single_detected_image_info(
            ...
            detections_dict={
                ...
                standard_fields.DetectionResultFields.detection_classes: np.array([1]),
                standard_fields.DetectionResultFields.detection_keypoints: np.array(
                    [[[75.0, 76.0], [5.0, 6.0], [7.0, 8.0], [77.0, 78.0]]]
                ),
            },
        )
        metrics = coco_evaluator.evaluate()
        self.assertAlmostEqual(
            metrics["Keypoints_Precision/mAP ByCategory/person"], 1.0
        )
    ...
    def testGroundtruthListValues(self):
        ...
        coco_evaluator.add_single_ground_truth_image_info(
            ...
            groundtruth_dict={
                ...
                standard_fields.InputDataFields.groundtruth_area: np.array([15.0]),
            },
        )
        ...
        self.assertAlmostEqual(gt_dict["keypoints"], [160.0, 150.0, 2, 180.0, 170.0, 2])
    ...
    def testFiltersDetectionsFromOtherCategories(self):
        ...
        coco_evaluator.add_single_ground_truth_image_info(
            ...
            groundtruth_dict={
                ...
                standard_fields.InputDataFields.groundtruth_classes: np.array([1]),
                standard_fields.InputDataFields.groundtruth_keypoints: np.array(
                    [[[150.0, 160.0], [170.0, 180.0], [110.0, 120.0], [130.0, 140.0]]]
                ),
                standard_fields.InputDataFields.groundtruth_keypoint_visibilities: np.array(
                    [[2, 2, 2, 2]]
                ),
        ...
        coco_evaluator.add_single_detected_image_info(
            ...
            detections_dict={
                ...
                standard_fields.DetectionResultFields.detection_scores: np.array([0.9]),
                standard_fields.DetectionResultFields.detection_classes: np.array([1]),
                standard_fields.DetectionResultFields.detection_keypoints: np.array(
                    [[[150.0, 160.0], [170.0, 180.0], [110.0, 120.0], [130.0, 140.0]]]
                ),
        ...
        metrics = coco_evaluator.evaluate()
        self.assertAlmostEqual(metrics["Keypoints_Precision/mAP ByCategory/dog"], -1.0)
    ...
    def testHandlesUnlabeledKeypointData(self):
        ...
        coco_evaluator.add_single_detected_image_info(
            ...
            detections_dict={
                ...
                standard_fields.DetectionResultFields.detection_classes: np.array([1]),
                standard_fields.DetectionResultFields.detection_keypoints: np.array(
                    [[[50.0, 60.0], [1.0, 2.0], [3.0, 4.0], [170.0, 180.0]]]
                ),
            },
        )
        metrics = coco_evaluator.evaluate()
    ...
    def testIgnoresCrowdAnnotations(self):
        ...
        coco_evaluator.add_single_ground_truth_image_info(
            ...
            groundtruth_dict={
                ...
                standard_fields.InputDataFields.groundtruth_classes: np.array([1]),
                standard_fields.InputDataFields.groundtruth_is_crowd: np.array([1]),
                standard_fields.InputDataFields.groundtruth_keypoints: np.array(
                    [
                        [
                            [150.0, 160.0],
...
class CocoKeypointEvaluationPyFuncTest(tf.test.TestCase):
    def testGetOneMAPWithMatchingKeypoints(self):
        ...
        self.assertAlmostEqual(metrics["Keypoints_Recall/AR@1 ByCategory/person"], 1.0)
        self.assertAlmostEqual(metrics["Keypoints_Recall/AR@10 ByCategory/person"], 1.0)
        self.assertAlmostEqual(
            metrics["Keypoints_Recall/AR@100 ByCategory/person"], 1.0
        )
        self.assertAlmostEqual(
    ...
    def testGetOneMAPWithMatchingKeypointsAndVisibilities(self):
        ...
        groundtruth_classes = tf.placeholder(tf.float32, shape=(None))
        groundtruth_keypoints = tf.placeholder(tf.float32, shape=(None, 4, 2))
        groundtruth_keypoint_visibilities = tf.placeholder(tf.float32, shape=(None, 4))
        detection_boxes = tf.placeholder(tf.float32, shape=(None, 4))
        detection_scores = tf.placeholder(tf.float32, shape=(None))
        detection_classes = tf.placeholder(tf.float32, shape=(None))
        detection_keypoints = tf.placeholder(tf.float32, shape=(None, 4, 2))
        ...
        eval_dict = {
            ...
            input_data_fields.groundtruth_classes: groundtruth_classes,
            input_data_fields.groundtruth_keypoints: groundtruth_keypoints,
            input_data_fields.groundtruth_keypoint_visibilities: groundtruth_keypoint_visibilities,
            detection_fields.detection_boxes: detection_boxes,
            detection_fields.detection_scores: detection_scores,
            detection_fields.detection_classes: detection_classes,
            detection_fields.detection_keypoints: detection_keypoints,
        ...
        with self.test_session() as sess:
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_keypoint_visibilities: np.array([[0, 0, 0, 2]]),
                    detection_boxes: np.array([[100.0, 100.0, 200.0, 200.0]]),
                    detection_scores: np.array([0.8]),
                    detection_classes: np.array([1]),
                    detection_keypoints: np.array(
        ...
        with self.test_session() as sess:
            ...
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_boxes: np.zeros((0, 4)),
                    groundtruth_classes: np.zeros((0)),
                    groundtruth_keypoints: np.zeros((0, 4, 2)),
                    is_annotated: False,  # Note that this image isn't annotated.
                    detection_boxes: np.array(
                        [
                            [25.0, 25.0, 50.0, 50.0],
    ...
    def testGetOneMAPWithMatchingKeypointsBatched(self):
        ...
        detection_scores = tf.placeholder(tf.float32, shape=(batch_size, None))
        detection_classes = tf.placeholder(tf.float32, shape=(batch_size, None))
        detection_keypoints = tf.placeholder(tf.float32, shape=(batch_size, None, 4, 2))
        ...
        with self.test_session() as sess:
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_boxes: np.array(
                        [[[100.0, 100.0, 200.0, 200.0]], [[50.0, 50.0, 100.0, 100.0]]]
                    ),
                    ...
                    detection_scores: np.array([[0.8], [0.7]]),
    ...
    def testGetOneMAPWithMatchingGroundtruthAndDetections(self):
        ...
        coco_evaluator.add_single_ground_truth_image_info(
            ...
            groundtruth_dict={
                ...
                standard_fields.InputDataFields.groundtruth_classes: np.array([1]),
                standard_fields.InputDataFields.groundtruth_instance_masks: np.pad(
        ...
        coco_evaluator.add_single_detected_image_info(
            ...
            detections_dict={
                ...
                standard_fields.DetectionResultFields.detection_scores: np.array([0.8]),
                standard_fields.DetectionResultFields.detection_classes: np.array([1]),
                standard_fields.DetectionResultFields.detection_masks: np.pad(
                    np.ones([1, 100, 100], dtype=np.uint8),
                    ((0, 0), (10, 10), (10, 10)),
                    mode="constant",
                ),
        ...
        coco_evaluator.add_single_detected_image_info(
            ...
            detections_dict={
                ...
                np.pad(
                    5 * np.ones([1, 25, 25], dtype=np.uint8),
                    ((0, 0), (10, 10), (10, 10)),
                    mode="constant",
                ),
            },
    ...
    def testGetOneMAPWithMatchingGroundtruthAndDetectionsSkipCrowd(self):
        ...
        coco_evaluator.add_single_ground_truth_image_info(
            ...
            groundtruth_dict={
                ...
                standard_fields.InputDataFields.groundtruth_classes: np.array([1, 2]),
                standard_fields.InputDataFields.groundtruth_is_crowd: np.array([0, 1]),
                standard_fields.InputDataFields.groundtruth_instance_masks: np.concatenate(
                    [
                        np.pad(
                            np.ones([1, 100, 100], dtype=np.uint8),
                            ((0, 0), (100, 56), (100, 56)),
                        ...
                        np.pad(
                            np.ones([1, 101, 101], dtype=np.uint8),
                            ((0, 0), (99, 56), (99, 56)),
                            mode="constant",
                        ),
                    ],
...
class CocoMaskEvaluationPyFuncTest(tf.test.TestCase):
    def testAddEvalDict(self):
        ...
        eval_dict = {
            ...
            input_data_fields.original_image_spatial_shape: original_image_spatial_shape,
            detection_fields.detection_scores: detection_scores,
            detection_fields.detection_classes: detection_classes,
        ...
        with self.test_session() as sess:
            sess.run(
                ...
                feed_dict={
                    ...
                    detection_classes: np.array([2, 1]),
    ...
    def test_panoptic_quality(self):
        ...
        for i in range(2):
            pq_evaluator.add_single_ground_truth_image_info(
                image_id="image%d" % i,
                groundtruth_dict={
                    standard_fields.InputDataFields.groundtruth_classes: gt_class[i],
                    standard_fields.InputDataFields.groundtruth_instance_masks: gt_masks[
                        i
                    ],
                    standard_fields.InputDataFields.groundtruth_is_crowd: gt_is_crowd[
                        i
                    ],
                },
            )
            ...
            pq_evaluator.add_single_detected_image_info(
                image_id="image%d" % i,
                detections_dict={
                    standard_fields.DetectionResultFields.detection_classes: result_class[
                        i
                    ],
                    standard_fields.DetectionResultFields.detection_masks: result_masks[
                        i
                    ],
                },
            )
        ...
        self.assertAlmostEqual(
            metrics["PanopticQuality@0.50IOU_ByCategory/person"], 0.32
        )
        self.assertAlmostEqual(
            metrics["PanopticQuality@0.50IOU_ByCategory/dog"], 135.0 / 195
        )
        self.assertAlmostEqual(metrics["PanopticQuality@0.50IOU_ByCategory/cat"], 0)
        self.assertAlmostEqual(
            metrics["SegmentationQuality@0.50IOU"], (0.8 + 135.0 / 195) / 3
        )
        self.assertAlmostEqual(metrics["RecognitionQuality@0.50IOU"], (0.4 + 1) / 3)
        self.assertAlmostEqual(
            metrics["PanopticQuality@0.50IOU"], (0.32 + 135.0 / 195) / 3
        )
        ...
        with self.test_session() as sess:
            sess.run(
                ...
                feed_dict={
                    ...
                    groundtruth_classes: np.stack(
                        [gt_class[0], np.pad(gt_class[1], (0, 1), mode="constant")],
                        axis=0,
                    ),
                    groundtruth_masks: np.stack(
                        [
                            np.pad(
                                gt_masks[0], ((0, 0), (0, 10), (0, 10)), mode="constant"
                            ),
                            np.pad(
                                gt_masks[1], ((0, 1), (0, 30), (0, 20)), mode="constant"
                            ),
                        ],
                        axis=0,
                    ),
                    groundtruth_is_crowd: np.stack(
                        [
                            gt_is_crowd[0],
