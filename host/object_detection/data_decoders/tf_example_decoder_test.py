...
class TfExampleDecoderTest(test_case.TestCase):
    ...
    def testDecodeAdditionalChannels(self):
        ...
        ) = self._create_encoded_and_decoded_data(additional_channel, "jpeg")
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        ...
                        "image/additional_channels/encoded": dataset_util.bytes_list_feature(
    ...
    def testDecodeJpegImage(self):
        ...
        self.assertAllEqual(
            [4, 5], tensor_dict[fields.InputDataFields.original_image_spatial_shape]
        )
        self.assertEqual(
    ...
    def testDecodePngImage(self):
        image = np.random.randint(256, size=(4, 5, 3)).astype(np.uint8)
        encoded_png, decoded_png = self._create_encoded_and_decoded_data(image, "png")
    ...
    def testDecodeBoundingBox(self):
        ...
        encoded_jpeg, _ = self._create_encoded_and_decoded_data(image_tensor, "jpeg")
        bbox_ymins = [0.0, 4.0]
        bbox_xmins = [1.0, 5.0]
        bbox_ymaxs = [2.0, 6.0]
        bbox_xmaxs = [3.0, 7.0]
        ...
        expected_boxes = np.vstack(
            [bbox_ymins, bbox_xmins, bbox_ymaxs, bbox_xmaxs]
        ).transpose()
        self.assertAllEqual(
            expected_boxes, tensor_dict[fields.InputDataFields.groundtruth_boxes]
        )
    ...
    def testDecodeKeypointDepth(self):
        ...
        def graph_fn():
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        ...
                        "image/object/keypoint/y": dataset_util.float_list_feature(
                            keypoint_ys
                        ),
                        "image/object/keypoint/x": dataset_util.float_list_feature(
                            keypoint_xs
                        ),
                        "image/object/keypoint/z": dataset_util.float_list_feature(
                            keypoint_depths
                        ),
                        "image/object/keypoint/z/weights": dataset_util.float_list_feature(
                            keypoint_depth_weights
                        ),
                        "image/object/keypoint/visibility": dataset_util.int64_list_feature(
                            keypoint_visibility
                        ),
                    }
                )
            ...
            self.assertAllEqual(
                (
                    output[fields.InputDataFields.groundtruth_keypoint_depths]
                    .get_shape()
                    .as_list()
                ),
                [2, 3],
    ...
    def testDecodeKeypoint(self):
        ...
        expected_visibility = (np.array(keypoint_visibility) > 0).reshape((2, 3))
        self.assertAllEqual(
            expected_visibility,
    ...
    def testDecodeKeypointNoInstance(self):
        ...
        self.assertAllEqual(
            [0, 3, 2], tensor_dict[fields.InputDataFields.groundtruth_keypoints].shape
        )
    ...
    """
        ...
        self.assertAllEqual(
            expected_boxes, output[fields.InputDataFields.groundtruth_boxes]
        )
        ...
        self.assertAllClose(
            expected_keypoints, output[fields.InputDataFields.groundtruth_keypoints]
        )
    ...
    def testDecodeObjectLabel(self):
        ...
        def graph_fn():
            ...
            self.assertAllEqual(
                (
                    output[fields.InputDataFields.groundtruth_classes]
                    .get_shape()
                    .as_list()
                ),
                [2],
        ...
        self.assertAllEqual(
            bbox_classes, tensor_dict[fields.InputDataFields.groundtruth_classes]
        )
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/object/class/multiclass_scores": dataset_util.float_list_feature(
    ...
    def testDecodeObjectLabelUnrecognizedName(self):
      ...
      """
        ...
        tensor_dict = self.execute_cpu(graph_fn, [])
        self.assertAllEqual(
            [2, -1], tensor_dict[fields.InputDataFields.groundtruth_classes]
        )
    ...
    def testDecodeObjectArea(self):
        ...
        def graph_fn():
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/object/area": dataset_util.float_list_feature(
                            object_area
                        ),
                    }
                )
            ...
            self.assertAllEqual(
                (output[fields.InputDataFields.groundtruth_area].get_shape().as_list()),
                [2],
            )
            return output
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/neg_category_ids": dataset_util.int64_list_feature(
                            neg_category_ids
                        ),
                    }
                )
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/not_exhaustive_category_ids": dataset_util.int64_list_feature(
    ...
    def testDecodeObjectIsCrowd(self):
        ...
        def graph_fn():
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/object/is_crowd": dataset_util.int64_list_feature(
                            object_is_crowd
                        ),
                    }
                )
            ...
            self.assertAllEqual(
                (
                    output[fields.InputDataFields.groundtruth_is_crowd]
                    .get_shape()
                    .as_list()
                ),
                [2],
    ...
    def testDecodeObjectDifficult(self):
        ...
        def graph_fn():
            ...
            self.assertAllEqual(
                (
                    output[fields.InputDataFields.groundtruth_difficult]
                    .get_shape()
                    .as_list()
                ),
                [2],
    ...
    def testDecodeObjectGroupOf(self):
        ...
        def graph_fn():
            ...
            self.assertAllEqual(
                (
                    output[fields.InputDataFields.groundtruth_group_of]
                    .get_shape()
                    .as_list()
                ),
                [2],
    ...
    def testDecodeObjectWeight(self):
        ...
        def graph_fn():
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/object/weight": dataset_util.float_list_feature(
                            object_weights
                        ),
                    }
                )
            ...
            self.assertAllEqual(
                (
                    output[fields.InputDataFields.groundtruth_weights]
                    .get_shape()
                    .as_list()
                ),
                [None],
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/class/confidence": dataset_util.float_list_feature(
                            class_confidence
                        ),
                    }
                )
    ...
    def testDecodeInstanceSegmentation(self):
        ...
        image_tensor = np.random.randint(
            256, size=(image_height, image_width, 3)
        ).astype(np.uint8)
        encoded_jpeg, _ = self._create_encoded_and_decoded_data(image_tensor, "jpeg")

        # Randomly generate instance segmentation masks.
        instance_masks = np.random.randint(
            2, size=(num_instances, image_height, image_width)
        ).astype(np.float32)
        ...
        def graph_fn():
            ...
            self.assertAllEqual(
                (
                    output[fields.InputDataFields.groundtruth_instance_masks]
                    .get_shape()
                    .as_list()
                ),
                [4, 5, 3],
    ...
    def testInstancesNotAvailableByDefault(self):
        ...
        tensor_dict = self.execute_cpu(graph_fn, [])
        self.assertNotIn(fields.InputDataFields.groundtruth_instance_masks, tensor_dict)
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        ...
                        "image/object/mask/weight": dataset_util.float_list_feature(
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/class/text": dataset_util.bytes_list_feature(
                            [six.b("dog"), six.b("cat")]
                        ),
                    }
                )
            ...
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        "image/encoded": dataset_util.bytes_feature(encoded_jpeg),
                        "image/format": dataset_util.bytes_feature(six.b("jpeg")),
                        "image/context_features": dataset_util.float_list_feature(
                            context_features
                        ),
                        "image/context_feature_length": dataset_util.int64_feature(
    ...
    def testContextFeaturesNotAvailableByDefault(self):
        ...
        tensor_dict = self.execute_cpu(graph_fn, [])
        self.assertNotIn(fields.InputDataFields.context_features, tensor_dict)
    ...
    """
        ...
        boxes = np.vstack([bbox_ymins, bbox_xmins, bbox_ymaxs, bbox_xmaxs]).transpose()
    ...
    def testDecodeDensePose(self):
        ...
        def graph_fn():
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        ...
                        "image/object/densepose/num": dataset_util.int64_list_feature(
                            densepose_num
                        ),
                        "image/object/densepose/part_index": dataset_util.int64_list_feature(
                            densepose_part_index
                        ),
                        "image/object/densepose/x": dataset_util.float_list_feature(
                            densepose_x
                        ),
                        "image/object/densepose/y": dataset_util.float_list_feature(
                            densepose_y
                        ),
                        "image/object/densepose/u": dataset_util.float_list_feature(
                            densepose_u
                        ),
                        "image/object/densepose/v": dataset_util.float_list_feature(
                            densepose_v
                        ),
                    }
                )
            ...
            example_decoder = tf_example_decoder.TfExampleDecoder(load_dense_pose=True)
            output = example_decoder.decode(tf.convert_to_tensor(example))
        ...
        expected_dp_part_ids = [[0, 0, 0, 0], [2, 2, 3, 4], [2, 9, 0, 0]]
    ...
    def testDecodeTrack(self):
        ...
        def graph_fn():
            example = tf.train.Example(
                features=tf.train.Features(
                    feature={
                        ...
                        "image/object/track/label": dataset_util.int64_list_feature(
                            track_labels
                        ),
                    }
                )
            ...
            example_decoder = tf_example_decoder.TfExampleDecoder(load_track_id=True)
            output = example_decoder.decode(tf.convert_to_tensor(example))
