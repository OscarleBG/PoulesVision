...
if tf_version.is_tf1():
    from tensorflow.tools.graph_transforms import (
        TransformGraph,
...
def append_postprocessing_op(
    ...
    new_output.attr["_output_types"].list.type.extend(
        [types_pb2.DT_FLOAT, types_pb2.DT_FLOAT, types_pb2.DT_FLOAT, types_pb2.DT_FLOAT]
    )
    ...
    transformed_graph_def = TransformGraph(
        frozen_graph_def, input_names, output_names, transforms
    )
