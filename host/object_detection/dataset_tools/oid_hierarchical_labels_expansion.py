...
flags.DEFINE_string(
    "input_annotations",
    None,
    "Path to Open Images annotations file"
...
flags.DEFINE_integer(
    "annotation_type",
    None,
    "Type of the input annotations: 1 - boxes or segments," "2 - image-level labels.",
)
...
class OIDHierarchicalLabelsExpansion(object):
    ...
    def expand_labels_from_csv(
        self, csv_row, labelname_column_index=1, confidence_column_index=2
    ):
