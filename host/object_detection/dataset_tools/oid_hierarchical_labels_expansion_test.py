...
def create_test_data():
    ...
    label_rows = [
        "123,verification,b,0",
        "123,verification,c,0",
        "124,verification,d,1",
    ]
    segm_rows = [
...
class HierarchicalLabelsExpansionTest(tf.test.TestCase):
    def test_bbox_expansion(self):
        ...
        expansion_generator = (
            oid_hierarchical_labels_expansion.OIDHierarchicalLabelsExpansion(hierarchy)
        )
        all_result_rows = []
    ...
    def test_labels_expansion(self):
        ...
        self.assertItemsEqual(
            [
                "123,verification,b,0",
                "123,verification,c,0",
                "123,verification,d,0",
                "123,verification,f,0",
                "123,verification,e,0",
                "124,verification,d,1",
                "124,verification,f,1",
