...
class CreateKittiTFRecordTest(tf.test.TestCase):
    ...
    def test_dict_to_tf_example(self):
        ...
        example = create_kitti_tf_record.prepare_example(
            save_path, annotations, label_map_dict
        )
        ...
        self._assertProtoEqual(
            example.features.feature["image/format"].bytes_list.value, [six.b("png")]
        )
        self._assertProtoEqual(
        ...
        self._assertProtoEqual(
            example.features.feature["image/object/truncated"].float_list.value, [1]
        )
        self._assertProtoEqual(
            example.features.feature["image/object/alpha"].float_list.value, [2]
        )
        self._assertProtoEqual(
            example.features.feature["image/object/3d_bbox/height"].float_list.value,
            [10],
        )
        self._assertProtoEqual(
        ...
        self._assertProtoEqual(
            example.features.feature["image/object/3d_bbox/length"].float_list.value,
            [12],
        )
        self._assertProtoEqual(
            example.features.feature["image/object/3d_bbox/x"].float_list.value, [13]
        )
        self._assertProtoEqual(
            example.features.feature["image/object/3d_bbox/y"].float_list.value, [14]
        )
        self._assertProtoEqual(
            example.features.feature["image/object/3d_bbox/z"].float_list.value, [15]
        )
        self._assertProtoEqual(
            example.features.feature["image/object/3d_bbox/rot_y"].float_list.value, [4]
        )
