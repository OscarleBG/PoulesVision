...
flags.DEFINE_string(
    "label_map_path", "data/pet_label_map.pbtxt", "Path to label map proto"
)
flags.DEFINE_boolean(
    "faces_only",
    True,
    "If True, generates bounding boxes "
...
def main(_):
    ...
    if not FLAGS.faces_only:
        ...
        val_output_path = os.path.join(
            FLAGS.output_dir, "pets_fullbody_with_masks_val.record"
        )
    create_tf_record(
        train_output_path,
        FLAGS.num_shards,
