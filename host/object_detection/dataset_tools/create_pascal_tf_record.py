...
flags.DEFINE_string(
    "label_map_path", "data/pascal_label_map.pbtxt", "Path to label map proto"
)
...
def main(_):
    ...
    for year in years:
        ...
        examples_path = os.path.join(
            data_dir, year, "ImageSets", "Main", "aeroplane_" + FLAGS.set + ".txt"
        )
        ...
        for idx, example in enumerate(examples_list):
            ...
            tf_example = dict_to_tf_example(
                data, FLAGS.data_dir, label_map_dict, FLAGS.ignore_difficult_instances
            )
