...
class ModelBuilderTF2Test(model_builder_test.ModelBuilderTest, parameterized.TestCase):
    ...
    """
      ...
      """
        config = text_format.Merge(
            task_proto_txt, center_net_pb2.CenterNet.KeypointEstimation()
        )
        return config
    ...
    """
      ...
      """
        return text_format.Merge(
            proto_txt, center_net_pb2.CenterNet.ObjectCenterParams()
        )
    ...
    """
        return text_format.Merge(proto_txt, center_net_pb2.CenterNet.ObjectDetection())
    ...
    """
        return text_format.Merge(proto_txt, center_net_pb2.CenterNet.MaskEstimation())
    ...
    """
        return text_format.Merge(
            proto_txt, center_net_pb2.CenterNet.DensePoseEstimation()
        )

    @parameterized.parameters(
        {"customize_head_params": True}, {"customize_head_params": False}
    )
    ...
    """
        ...
        config.center_net.keypoint_estimation_task.append(
            self.get_fake_keypoint_proto(customize_head_params=customize_head_params)
        )
        config.center_net.keypoint_label_map_path = self.get_fake_label_map_file_path()
        config.center_net.mask_estimation_task.CopyFrom(
            self.get_fake_mask_proto(customize_head_params=customize_head_params)
        )
        ...
        self.assertIsInstance(
            model._center_params.classification_loss,
        ...
        self.assertAlmostEqual(model._center_params.heatmap_bias_init, 3.14, places=4)
        ...
        self.assertIsInstance(
            model._od_params.localization_loss, losses.L1LocalizationLoss
        )
        ...
        self.assertIsInstance(kp_params.localization_loss, losses.L1LocalizationLoss)
        ...
        self.assertIsInstance(
            model._mask_params.classification_loss,
        ...
        self.assertAlmostEqual(model._mask_params.heatmap_bias_init, -2.0, places=4)
        if customize_head_params:
        ...
        self.assertIsInstance(
            model._densepose_params.classification_loss,
            losses.WeightedSoftmaxClassificationLoss,
        )
        self.assertIsInstance(
            model._densepose_params.localization_loss, losses.L1LocalizationLoss
        )
        ...
        self.assertIsInstance(
            ...
            center_net_hourglass_feature_extractor.CenterNetHourglassFeatureExtractor,
        )
    ...
    """
        ...
        self.assertEqual(model._num_classes, 10)
        self.assertEqual(
            model._center_params.keypoint_weights_for_center, [1.0, 0.0, 1.0, 0.0]
        )
