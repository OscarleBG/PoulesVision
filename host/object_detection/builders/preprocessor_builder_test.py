...
class PreprocessorBuilderTest(tf.test.TestCase):
    ...
    """
        ...
        self.assert_dictionary_close(
            args, {"min_scale_ratio": 0.8, "max_scale_ratio": 2.2}
        )
    ...
    """
        ...
        self.assert_dictionary_close(
            args, {"aspect_ratio": 0.85, "overlap_thresh": 0.35, "clip_boxes": False}
        )
    ...
    """
        ...
        self.assert_dictionary_close(
            args,
            {"max_black_patches": 20, "probability": 0.95, "size_to_image_ratio": 0.12},
        )
    ...
    """
        ...
        self.assert_dictionary_close(
            args, {"random_coef": 0.5, "min_jpeg_quality": 40, "max_jpeg_quality": 90}
        )
    ...
    """
        ...
        self.assert_dictionary_close(
            args,
            {"random_coef": 0.5, "min_target_pixels": 200, "max_target_pixels": 900},
        )
    ...
    """
        ...
        self.assert_dictionary_close(
            args, {"dropped_label": 2, "drop_probability": 0.5}
        )
    ...
    """
        ...
        self.assertEqual(
            args,
            {"concat_vertical_probability": 0.5, "concat_horizontal_probability": 0.25},
        )
    ...
    """
        ...
        self.assertEqual(
            args,
            {"scale_min": 0.25, "scale_max": 2.0, "num_scales": 8, "max_border": 128},
        )
