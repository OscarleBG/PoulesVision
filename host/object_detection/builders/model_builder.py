...
if tf_version.is_tf2():
    ...
    from object_detection.models import (
        faster_rcnn_inception_resnet_v2_keras_feature_extractor as frcnn_inc_res_keras,
    )
    from object_detection.models import (
        faster_rcnn_resnet_keras_feature_extractor as frcnn_resnet_keras,
    )
    from object_detection.models import (
        ssd_resnet_v1_fpn_keras_feature_extractor as ssd_resnet_v1_fpn_keras,
    )
    from object_detection.models import (
        faster_rcnn_resnet_v1_fpn_keras_feature_extractor as frcnn_resnet_fpn_keras,
    )
    from object_detection.models.ssd_mobilenet_v1_fpn_keras_feature_extractor import (
        SSDMobileNetV1FpnKerasFeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v1_keras_feature_extractor import (
    ...
    from object_detection.models.ssd_mobilenet_v2_keras_feature_extractor import (
...
if tf_version.is_tf1():
    ...
    from object_detection.models import (
        faster_rcnn_inception_v2_feature_extractor as frcnn_inc_v2,
    )
    ...
    from object_detection.models import (
        ssd_resnet_v1_fpn_feature_extractor as ssd_resnet_v1_fpn,
    )
    from object_detection.models import (
        ssd_resnet_v1_ppn_feature_extractor as ssd_resnet_v1_ppn,
    )
    from object_detection.models.embedded_ssd_mobilenet_v1_feature_extractor import (
        EmbeddedSSDMobileNetV1FeatureExtractor,
    )
    from object_detection.models.ssd_inception_v2_feature_extractor import (
        SSDInceptionV2FeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v2_fpn_feature_extractor import (
        SSDMobileNetV2FpnFeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v2_mnasfpn_feature_extractor import (
        SSDMobileNetV2MnasFPNFeatureExtractor,
    )
    from object_detection.models.ssd_inception_v3_feature_extractor import (
        SSDInceptionV3FeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_edgetpu_feature_extractor import (
        SSDMobileNetEdgeTPUFeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v1_feature_extractor import (
        SSDMobileNetV1FeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v1_fpn_feature_extractor import (
        SSDMobileNetV1FpnFeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v1_ppn_feature_extractor import (
        SSDMobileNetV1PpnFeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v2_feature_extractor import (
        SSDMobileNetV2FeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v3_feature_extractor import (
        SSDMobileNetV3LargeFeatureExtractor,
    )
    from object_detection.models.ssd_mobilenet_v3_feature_extractor import (
        SSDMobileNetV3SmallFeatureExtractor,
    )
    from object_detection.models.ssd_mobiledet_feature_extractor import (
    ...
    from object_detection.models.ssd_spaghettinet_feature_extractor import (
        SSDSpaghettinetFeatureExtractor,
    )
    from object_detection.models.ssd_pnasnet_feature_extractor import (
...
if tf_version.is_tf2():
    ...
    FASTER_RCNN_KERAS_FEATURE_EXTRACTOR_CLASS_MAP = {
        "faster_rcnn_resnet50_keras": frcnn_resnet_keras.FasterRCNNResnet50KerasFeatureExtractor,
        "faster_rcnn_resnet101_keras": frcnn_resnet_keras.FasterRCNNResnet101KerasFeatureExtractor,
        "faster_rcnn_resnet152_keras": frcnn_resnet_keras.FasterRCNNResnet152KerasFeatureExtractor,
        "faster_rcnn_inception_resnet_v2_keras": frcnn_inc_res_keras.FasterRCNNInceptionResnetV2KerasFeatureExtractor,
        "faster_rcnn_resnet50_fpn_keras": frcnn_resnet_fpn_keras.FasterRCNNResnet50FpnKerasFeatureExtractor,
        "faster_rcnn_resnet101_fpn_keras": frcnn_resnet_fpn_keras.FasterRCNNResnet101FpnKerasFeatureExtractor,
        "faster_rcnn_resnet152_fpn_keras": frcnn_resnet_fpn_keras.FasterRCNNResnet152FpnKerasFeatureExtractor,
    }
    ...
    CENTER_NET_EXTRACTOR_FUNCTION_MAP = {
        ...
        "resnet_v1_18_fpn": center_net_resnet_v1_fpn_feature_extractor.resnet_v1_18_fpn,
        "resnet_v1_34_fpn": center_net_resnet_v1_fpn_feature_extractor.resnet_v1_34_fpn,
        "resnet_v1_50_fpn": center_net_resnet_v1_fpn_feature_extractor.resnet_v1_50_fpn,
        "resnet_v1_101_fpn": center_net_resnet_v1_fpn_feature_extractor.resnet_v1_101_fpn,
        "hourglass_10": center_net_hourglass_feature_extractor.hourglass_10,
        "hourglass_20": center_net_hourglass_feature_extractor.hourglass_20,
        "hourglass_32": center_net_hourglass_feature_extractor.hourglass_32,
        "hourglass_52": center_net_hourglass_feature_extractor.hourglass_52,
        "hourglass_104": center_net_hourglass_feature_extractor.hourglass_104,
        "mobilenet_v2": center_net_mobilenet_v2_feature_extractor.mobilenet_v2,
        "mobilenet_v2_fpn": center_net_mobilenet_v2_fpn_feature_extractor.mobilenet_v2_fpn,
        "mobilenet_v2_fpn_sep_conv": center_net_mobilenet_v2_fpn_feature_extractor.mobilenet_v2_fpn,
    }
...
if tf_version.is_tf1():
    SSD_FEATURE_EXTRACTOR_CLASS_MAP = {
        ...
        "ssd_mobilenet_v2_mnasfpn": SSDMobileNetV2MnasFPNFeatureExtractor,
        ...
        "ssd_mobiledet_gpu": SSDMobileDetGPUFeatureExtractor,
        "ssd_spaghettinet": SSDSpaghettinetFeatureExtractor,
    }
...
def _build_ssd_feature_extractor(
    feature_extractor_config, is_training, freeze_batchnorm, reuse_weights=None
):
    ...
    if feature_extractor_config.HasField("spaghettinet_arch_name"):
        kwargs.update(
            {
                "spaghettinet_arch_name": feature_extractor_config.spaghettinet_arch_name,
            }
        )
...
def _build_faster_rcnn_keras_feature_extractor(
    feature_extractor_config, is_training, inplace_batchnorm_update=False
):
...
def _build_faster_rcnn_model(frcnn_config, is_training, add_summaries):
    ...
    first_stage_sampler = sampler.BalancedPositiveNegativeSampler(
        ...
        is_static=(
            frcnn_config.use_static_balanced_label_sampler and use_static_shapes
        ),
    )
    first_stage_max_proposals = frcnn_config.first_stage_max_proposals
    if (
        frcnn_config.first_stage_nms_iou_threshold < 0
    ...
    common_kwargs = {
        ...
        "output_final_box_rpn_features": frcnn_config.output_final_box_rpn_features,
    }

    if (
        not is_keras
        and isinstance(second_stage_box_predictor, rfcn_box_predictor.RfcnBoxPredictor)
    ) or (
        is_keras
        and isinstance(
            second_stage_box_predictor, rfcn_keras_box_predictor.RfcnKerasBoxPredictor
        )
    ):
        return rfcn_meta_arch.RFCNMetaArch(
            second_stage_rfcn_box_predictor=second_stage_box_predictor, **common_kwargs
        )
    elif frcnn_config.HasField("context_config"):
        context_config = frcnn_config.context_config
        common_kwargs.update(
            {
                "attention_bottleneck_dimension": context_config.attention_bottleneck_dimension,
                "attention_temperature": context_config.attention_temperature,
                "use_self_attention": context_config.use_self_attention,
                "use_long_term_attention": context_config.use_long_term_attention,
                "self_attention_in_sequence": context_config.self_attention_in_sequence,
                "num_attention_heads": context_config.num_attention_heads,
                "num_attention_layers": context_config.num_attention_layers,
                "attention_position": context_config.attention_position,
            }
        )
...
def keypoint_proto_to_params(kp_config, keypoint_map_dict):
    ...
    classification_loss, localization_loss, _, _, _, _, _ = losses_builder.build(
        kp_config.loss
    )
    ...
    if kp_config.HasField("regress_head_params"):
        ...
        regress_head_kernel_sizes = list(kp_config.regress_head_params.kernel_sizes)
    else:
...
def _build_center_net_model(center_net_config, is_training, add_summaries):
    ...
    image_resizer_fn = image_resizer_builder.build(center_net_config.image_resizer)
    ...
    if center_net_config.HasField("track_estimation_task"):
        track_params = tracking_proto_to_params(center_net_config.track_estimation_task)
...
def _build_center_net_feature_extractor(feature_extractor_config, is_training):
    ...
    if feature_extractor_config.type not in CENTER_NET_EXTRACTOR_FUNCTION_MAP:
        raise ValueError(
            "'{}' is not a known CenterNet feature extractor type".format(
                feature_extractor_config.type
            )
        )
    # For backwards compatibility:
    use_separable_conv = (
        feature_extractor_config.use_separable_conv
        or feature_extractor_config.type == "mobilenet_v2_fpn_sep_conv"
    )
    kwargs = {
...
def build(model_config, is_training, add_summaries=True):
    ...
    if meta_architecture not in META_ARCH_BUILDER_MAP:
        ...
        return build_func(
            getattr(model_config, meta_architecture), is_training, add_summaries
        )
