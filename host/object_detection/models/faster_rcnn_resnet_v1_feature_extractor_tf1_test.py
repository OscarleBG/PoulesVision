...
from object_detection.models import (
    faster_rcnn_resnet_v1_feature_extractor as faster_rcnn_resnet_v1,
)
...
class FasterRcnnResnetV1FeatureExtractorTest(tf.test.TestCase):
    def _build_feature_extractor(
        ...
        feature_extractor_map = {
            "resnet_v1_50": faster_rcnn_resnet_v1.FasterRCNNResnet50FeatureExtractor,
    ...
    def test_overwriting_activation_fn(self):
        for architecture in ["resnet_v1_50", "resnet_v1_101", "resnet_v1_152"]:
            ...
            self.assertIn(
                "TestStage1Scope/resnet_v1_50/resnet_v1_50/conv1/Relu6", op_names
            )
            self.assertIn(
