...
class SSDResnet50V1PpnFeatureExtractorTest(
    ssd_resnet_v1_ppn_feature_extractor_testbase.SSDResnetPpnFeatureExtractorTestBase
):
...
class SSDResnet101V1PpnFeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        min_depth = 32
        is_training = True
        return ssd_resnet_v1_ppn_feature_extractor.SSDResnet101V1PpnFeatureExtractor(
            is_training,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
...
class SSDResnet152V1PpnFeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        min_depth = 32
        is_training = True
        return ssd_resnet_v1_ppn_feature_extractor.SSDResnet152V1PpnFeatureExtractor(
            is_training,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
