...
class InceptionResnetV2Test(test_case.TestCase):
    ...
    def _check_returns_correct_shape(
        ...
        image_tensor = np.random.rand(
            _BATCH_SIZE, image_height, image_width, _NUM_CHANNELS
        ).astype(np.float32)
    ...
    def test_returns_correct_shapes_128(self):
        image_height = 128
        image_width = 128
        expected_feature_map_shape = _SLIM_ENDPOINT_SHAPES_128
    ...
    def test_returns_correct_shapes_128_output_stride_8(self):
        image_height = 128
        image_width = 128
        expected_feature_map_shape = _SLIM_ENDPOINT_SHAPES_128_STRIDE_8
        ...
        layer_names = [l for l in _KERAS_LAYERS_TO_CHECK if l not in excluded_layers]
        self._check_returns_correct_shape(
            image_height,
            image_width,
            expected_feature_map_shape,
    ...
    def test_returns_correct_shapes_128_align_feature_maps_false(self):
        image_height = 128
        image_width = 128
        expected_feature_map_shape = _SLIM_ENDPOINT_SHAPES_128_ALIGN_FEATURE_MAPS_FALSE
        self._check_returns_correct_shape(
            image_height,
            image_width,
            expected_feature_map_shape,
