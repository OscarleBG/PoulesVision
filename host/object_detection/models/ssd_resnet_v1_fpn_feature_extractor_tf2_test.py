...
class SSDResnet50V1FeatureExtractorTest(
    ssd_resnet_v1_fpn_feature_extractor_testbase.SSDResnetFPNFeatureExtractorTestBase
):
    ...
    def _create_feature_extractor(
        ...
        is_training = True
        return ssd_resnet_v1_fpn_keras_feature_extractor.SSDResNet50V1FpnKerasFeatureExtractor(
...
class SSDResnet101V1FeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        is_training = True
        return ssd_resnet_v1_fpn_keras_feature_extractor.SSDResNet101V1FpnKerasFeatureExtractor(
            is_training=is_training,
            depth_multiplier=depth_multiplier,
            min_depth=min_depth,
            pad_to_multiple=pad_to_multiple,
...
class SSDResnet152V1FeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        is_training = True
        return ssd_resnet_v1_fpn_keras_feature_extractor.SSDResNet152V1FpnKerasFeatureExtractor(
            is_training=is_training,
            depth_multiplier=depth_multiplier,
            min_depth=min_depth,
            pad_to_multiple=pad_to_multiple,
