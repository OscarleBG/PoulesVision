...
class _ResnetFPN(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        feature_block_map = dict(list(zip(self._resnet_block_names, backbone_outputs)))
        ...
        last_feature_map = fpn_features[
            "top_down_block{}".format(self._base_fpn_max_level - 1)
        ]
    ...
    def get_proposal_feature_extractor_model(self, name=None):
        ...
        with tf.name_scope(name):
            with tf.name_scope("ResnetV1FPN"):
                ...
                feature_extractor_model = _ResnetFPN(
