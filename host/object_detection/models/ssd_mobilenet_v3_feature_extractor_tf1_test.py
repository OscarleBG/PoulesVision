...
class SsdMobilenetV3LargeFeatureExtractorTest(
    ssd_mobilenet_v3_feature_extractor_testbase._SsdMobilenetV3FeatureExtractorTestBase
):
    ...
    def _create_feature_extractor(
        ...
        """
        min_depth = 32
        return ssd_mobilenet_v3_feature_extractor.SSDMobileNetV3LargeFeatureExtractor(
            False,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
...
class SsdMobilenetV3SmallFeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        """
        min_depth = 32
        return ssd_mobilenet_v3_feature_extractor.SSDMobileNetV3SmallFeatureExtractor(
            False,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
