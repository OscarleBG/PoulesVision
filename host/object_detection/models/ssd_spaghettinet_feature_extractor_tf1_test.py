...
class SSDSpaghettiNetFeatureExtractorTest(
    ...
    def _test_spaghettinet_returns_correct_shapes(
        self, arch_name, expected_feature_map_shapes
    ):
    ...
    def test_spaghettinet_edgetpu_s(self):
        ...
        self._test_spaghettinet_returns_correct_shapes(
            "spaghettinet_edgetpu_s", expected_feature_map_shapes
        )
    ...
    def test_spaghettinet_edgetpu_m(self):
        ...
        self._test_spaghettinet_returns_correct_shapes(
            "spaghettinet_edgetpu_m", expected_feature_map_shapes
        )
    ...
    def test_spaghettinet_edgetpu_l(self):
        ...
        self._test_spaghettinet_returns_correct_shapes(
            "spaghettinet_edgetpu_l", expected_feature_map_shapes
        )
