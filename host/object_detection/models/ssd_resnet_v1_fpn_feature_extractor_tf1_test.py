...
class SSDResnet101V1FeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        is_training = True
        return ssd_resnet_v1_fpn_feature_extractor.SSDResnet101V1FpnFeatureExtractor(
            is_training,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
...
class SSDResnet152V1FeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        is_training = True
        return ssd_resnet_v1_fpn_feature_extractor.SSDResnet152V1FpnFeatureExtractor(
            is_training,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
