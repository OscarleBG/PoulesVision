...
class MultiResolutionFeatureMapGeneratorTest(test_case.TestCase):
    ...
    def _build_feature_map_generator(self, feature_map_layout, pool_residual=False):
    ...
    def test_get_expected_feature_map_shapes_with_embedded_ssd_mobilenet_v1(self):
        with test_utils.GraphContextOrNone() as g:
            image_features = {
                ...
                "Conv2d_13_pointwise": tf.random_uniform(
                    [4, 8, 8, 1024], dtype=tf.float32
                ),
            }
    ...
    def test_get_expected_variable_names_with_inception_v2_use_depthwise(self):
        ...
        expected_keras_variables = set(
            [
                ...
                ("FeatureMaps/Mixed_5c_2_Conv2d_3_3x3_s2_512_depthwise_conv/" "bias"),
                "FeatureMaps/Mixed_5c_2_Conv2d_3_3x3_s2_512_conv/kernel",
                "FeatureMaps/Mixed_5c_2_Conv2d_3_3x3_s2_512_conv/bias",
                "FeatureMaps/Mixed_5c_1_Conv2d_4_1x1_128_conv/kernel",
                "FeatureMaps/Mixed_5c_1_Conv2d_4_1x1_128_conv/bias",
                ...
                ("FeatureMaps/Mixed_5c_2_Conv2d_4_3x3_s2_256_depthwise_conv/" "bias"),
                "FeatureMaps/Mixed_5c_2_Conv2d_4_3x3_s2_256_conv/kernel",
                "FeatureMaps/Mixed_5c_2_Conv2d_4_3x3_s2_256_conv/bias",
                "FeatureMaps/Mixed_5c_1_Conv2d_5_1x1_128_conv/kernel",
                "FeatureMaps/Mixed_5c_1_Conv2d_5_1x1_128_conv/bias",
                ...
                ("FeatureMaps/Mixed_5c_2_Conv2d_5_3x3_s2_256_depthwise_conv/" "bias"),
                "FeatureMaps/Mixed_5c_2_Conv2d_5_3x3_s2_256_conv/kernel",
                "FeatureMaps/Mixed_5c_2_Conv2d_5_3x3_s2_256_conv/bias",
            ]
        )
...
@parameterized.parameters(
    {"use_native_resize_op": True}, {"use_native_resize_op": False}
)
        ...
        with tf_graph.as_default():
            ...
            for clip_by_value_op in expected_clip_by_value_ops:
                clip_input_tensor = tf_graph.get_operation_by_name(
                    "{}/Minimum".format(clip_by_value_op)
                ).inputs[0]
            ...
            with self.test_session() as session:
                ...
                for clip_by_value_op in expected_clip_by_value_ops:
                    ...
                    self.assertLessEqual(
                        before_clipping_lower_bound, expected_lower_bound
                    )
                    self.assertGreaterEqual(
                        before_clipping_upper_bound, expected_upper_bound
                    )
                    ...
                    self.assertGreaterEqual(
                        after_clipping_lower_bound, expected_lower_bound
                    )
                    self.assertLessEqual(
                        after_clipping_upper_bound, expected_upper_bound
                    )
        ...
        with self.test_session() as sess:
            ...
            if replace_pool_with_conv:
                self.assertDictEqual(
                    expected_conv_feature_map_shapes, out_feature_map_shapes
                )
            else:
                self.assertDictEqual(
                    expected_pool_feature_map_shapes, out_feature_map_shapes
                )
