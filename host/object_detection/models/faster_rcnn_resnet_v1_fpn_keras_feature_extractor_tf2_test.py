...
from object_detection.models import (
    faster_rcnn_resnet_v1_fpn_keras_feature_extractor as frcnn_res_fpn,
)
...
class FasterRCNNResnetV1FpnKerasFeatureExtractorTest(tf.test.TestCase):
    ...
    def test_extract_proposal_features_returns_expected_size(self):
        ...
        features_shapes = [
            tf.shape(rpn_feature_map) for rpn_feature_map in rpn_feature_maps
        ]
    ...
    def test_extract_box_classifier_features_returns_expected_size(self):
        ...
        proposal_classifier_features = model(proposal_feature_maps)
