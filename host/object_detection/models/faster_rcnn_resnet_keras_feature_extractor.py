...
class FasterRCNNResnetKerasFeatureExtractor(
    ...
    def __init__(
        ...
        super(FasterRCNNResnetKerasFeatureExtractor, self).__init__(
            is_training, first_stage_features_stride, batch_norm_trainable, weight_decay
        )
...
class FasterRCNNResnet50KerasFeatureExtractor(FasterRCNNResnetKerasFeatureExtractor):
...
class FasterRCNNResnet101KerasFeatureExtractor(FasterRCNNResnetKerasFeatureExtractor):
...
class FasterRCNNResnet152KerasFeatureExtractor(FasterRCNNResnetKerasFeatureExtractor):
