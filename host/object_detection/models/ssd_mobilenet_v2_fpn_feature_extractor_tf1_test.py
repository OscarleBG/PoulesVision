...
class SsdMobilenetV2FpnFeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        del use_keras
        min_depth = 32
        return ssd_mobilenet_v2_fpn_feature_extractor.SSDMobileNetV2FpnFeatureExtractor(
            is_training,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
    ...
    def test_extract_features_with_dynamic_image_shape(self, use_depthwise):
        use_keras = False
        image_height = 256
        image_width = 256
        depth_multiplier = 1.0
    ...
    def test_extract_features_raises_error_with_invalid_image_size(self, use_depthwise):
        use_keras = False
        image_height = 32
        image_width = 32
        depth_multiplier = 1.0
    ...
    def test_preprocess_returns_correct_value_range(self, use_depthwise):
        use_keras = False
        image_height = 256
        image_width = 256
        depth_multiplier = 1
    ...
    def test_fused_batchnorm(self, use_depthwise):
        ...
        image_placeholder = tf.placeholder(
            tf.float32, [1, image_height, image_width, 3]
        )
        feature_extractor = self._create_feature_extractor(
            depth_multiplier,
            pad_to_multiple,
    ...
    def test_get_expected_feature_map_variable_names(self, use_depthwise):
        use_keras = False
        depth_multiplier = 1.0
        pad_to_multiple = 1
