...
class EmbeddedSSDMobileNetV1FeatureExtractorTest(
    ...
    def _create_feature_extractor(
        self, depth_multiplier, pad_to_multiple, is_training=True
    ):
        ...
        """
        min_depth = 32
        return embedded_ssd_mobilenet_v1_feature_extractor.EmbeddedSSDMobileNetV1FeatureExtractor(
            is_training,
            depth_multiplier,
            min_depth,
            pad_to_multiple,
    ...
    def test_extract_features_returns_correct_shapes_with_pad_to_multiple_of_1(self):
        image_height = 256
        image_width = 256
        depth_multiplier = 1.0
        pad_to_multiple = 1
