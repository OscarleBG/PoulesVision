...
class SSDEfficientNetBiFPNFeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        pad_to_multiple = 1
        min_depth = 16
        return ssd_efficientnet_bifpn_feature_extractor.SSDEfficientNetBiFPNKerasFeatureExtractor(
            is_training=True,
    ...
    def test_efficientdet_feature_extractor_shapes(
        self,
    ...
    def test_efficientdet_feature_extractor_params(
        self,
        efficientdet_version,
        efficientnet_version,
        bifpn_num_iterations,
