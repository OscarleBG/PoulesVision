...
class SsdMobilenetV2FeatureExtractorTest(
    ...
    def _create_feature_extractor(
        ...
        del use_keras
        min_depth = 32
        return ssd_mobilenet_v2_keras_feature_extractor.SSDMobileNetV2KerasFeatureExtractor(
            is_training=False,
    ...
    def test_extract_features_returns_correct_shapes_128_explicit_padding(self):
        image_height = 128
        image_width = 128
        depth_multiplier = 1.0
        pad_to_multiple = 1
    ...
    def test_extract_features_raises_error_with_invalid_image_size(self):
        ...
        self.check_extract_features_raises_error_with_invalid_image_size(
            image_height, image_width, depth_multiplier, pad_to_multiple, use_keras=True
        )
